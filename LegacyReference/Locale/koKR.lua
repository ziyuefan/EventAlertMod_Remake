...
EA_TTIP_SPELLCOND_AURAVALUE1 = "활성화/비활성화, 오라 수치 1 (오른쪽에서 라벨 입력 가능)"
EA_TTIP_SPELLCOND_AURAVALUE2 = "활성화/비활성화, 오라 수치 2 (오른쪽에서 라벨 입력 가능)"
EA_TTIP_SPELLCOND_AURAVALUE3 = "활성화/비활성화, 오라 수치 3 (오른쪽에서 라벨 입력 가능)"
EA_TTIP_SPELLCOND_AURAVALUE4 = "활성화/비활성화, 오라 수치 4 (오른쪽에서 라벨 입력 가능)"
...
EA_TTIP_SCD_REMOVEWHENCOOLDOWN = "재사용 대기시간이 끝나면 주문 아이콘 제거"
EA_TTIP_SCD_GLOWWHENUSABLE = "사용 가능할 때 SCD 아이콘 빛나게 표시"
EA_TTIP_SCD_NOCOMBATSTILLKEEP = "전투 중이 아니어도 SCD 아이콘 유지"
EA_TTIP_SCD_ITEMCOOLDOWN = "아이템 재사용 대기시간 감지 전환 (성능에 영향, UI를 다시 불러와야 함)"

EA_TTIP_SHOWRUNESBAR = "룬 바를 버프 바 위에 표시"

EA_TTIP_SNAMEFONTSIZE = "주문 이름 글꼴 크기 조정 (오라 수치에 영향)"
EA_TTIP_TIMERFONTSIZE = "카운트다운 글꼴 크기 조정"
EA_TTIP_STACKFONTSIZE = "중첩 수 글꼴 크기 조정"


EA_XOPT_SCD_REMOVEWHENCOOLDOWN = "재사용 대기시간이 끝나면 주문 아이콘 제거"
EA_XOPT_SCD_GLOWWHENUSABLE = "사용 가능할 때 SCD 아이콘 빛나게 표시"
EA_XOPT_SCD_NOCOMBATSTILLKEEP = "전투 중이 아니어도 SCD 아이콘 유지"
EA_XOPT_SCD_ITEMCOOLDOWN = "아이템 재사용 대기시간 감지 전환"

EA_XOPT_SHOWRUNESBAR = "죽기 룬 바 표시"
...
EA_XOPT_SPELLCOND_AURAVALUE1 = "오라 수치 1 표시"
EA_XOPT_SPELLCOND_AURAVALUE2 = "오라 수치 2 표시"
EA_XOPT_SPELLCOND_AURAVALUE3 = "오라 수치 3 표시"
EA_XOPT_SPELLCOND_AURAVALUE4 = "오라 수치 4 표시"



EA_XICON_SNAMEFONTSIZE = "주문 이름 글꼴 크기"
EA_XICON_TIMERFONTSIZE = "카운트다운 글꼴 크기"
EA_XICON_STACKFONTSIZE = "중첩 수 글꼴 크기"
