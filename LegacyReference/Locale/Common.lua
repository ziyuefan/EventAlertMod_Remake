...
for i = 1, GetNumClasses() do 
	local classLocaleName,classFile,classId = GetClassInfo(i)
	EA_CLASS[classFile] = classLocaleName
end
EA_CLASS["OTHER"] = "OTHER"
...
EA_SPELL_POWER_ESSENCE = Enum.PowerType.Essence				-- 喚能師(龍能)
