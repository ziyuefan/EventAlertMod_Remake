...
EA_TTIP_SPELLCOND_AURAVALUE1 = "开启/关闭，光环数值 1（右侧可输入标签）"
EA_TTIP_SPELLCOND_AURAVALUE2 = "开启/关闭，光环数值 2（右侧可输入标签）"
EA_TTIP_SPELLCOND_AURAVALUE3 = "开启/关闭，光环数值 3（右侧可输入标签）"
EA_TTIP_SPELLCOND_AURAVALUE4 = "开启/关闭，光环数值 4（右侧可输入标签）"  
...
EA_TTIP_SCD_REMOVEWHENCOOLDOWN = "冷却时移除法术图标"
EA_TTIP_SCD_GLOWWHENUSABLE = "当可用时发光显示 SCD 图标"
EA_TTIP_SCD_NOCOMBATSTILLKEEP = "即使未进入战斗仍显示 SCD 图标"   
EA_TTIP_SCD_ITEMCOOLDOWN = "切换物品冷却检测（影响性能，需要重新加载界面）"
EA_TTIP_SHOWRUNESBAR = "将符文条显示在BUFF栏上方"

EA_TTIP_SNAMEFONTSIZE = "调整法术技能名称字体大小（影响光环数值）"
EA_TTIP_TIMERFONTSIZE = "调整倒计时字体大小"
EA_TTIP_STACKFONTSIZE = "调整层数字体大小"


EA_XOPT_SCD_REMOVEWHENCOOLDOWN = "冷却时移除法术图标"
EA_XOPT_SCD_GLOWWHENUSABLE = "当可用时发光显示 SCD 图标"
EA_XOPT_SCD_NOCOMBATSTILLKEEP = "即使未进入战斗仍显示 SCD 图标"
EA_XOPT_SCD_ITEMCOOLDOWN = "切换物品冷却检测"                   

EA_XOPT_SHOWRUNESBAR = "是否显示DK符文列"
...
EA_XOPT_SPELLCOND_AURAVALUE1 = "显示光环数值 1"
EA_XOPT_SPELLCOND_AURAVALUE2 = "显示光环数值 2"
EA_XOPT_SPELLCOND_AURAVALUE3 = "显示光环数值 3"
EA_XOPT_SPELLCOND_AURAVALUE4 = "显示光环数值 4"
...
EA_XICON_SNAMEFONTSIZE = "法术名称字体大小"
EA_XICON_TIMERFONTSIZE = "倒计时字体大小"
EA_XICON_STACKFONTSIZE = "层数字体大小"
