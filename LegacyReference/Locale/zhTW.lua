...
EA_TTIP_SPELLCOND_AURAVALUE1 = "開啟/關閉, 光環數值 1 (右側可輸入標籤)"
EA_TTIP_SPELLCOND_AURAVALUE2 = "開啟/關閉, 光環數值 2 (右側可輸入標籤)"
EA_TTIP_SPELLCOND_AURAVALUE3 = "開啟/關閉, 光環數值 3 (右側可輸入標籤)"
EA_TTIP_SPELLCOND_AURAVALUE4 = "開啟/關閉, 光環數值 4 (右側可輸入標籤)"

EA_TTIP_SNAMEFONTSIZE =	"調整法術技能名稱字體大小(影響光環數值)"
EA_TTIP_TIMERFONTSIZE =	"調整倒數字體大小"
EA_TTIP_STACKFONTSIZE =	"調整層數字體大小"
...
EA_TTIP_GRPCFG_GLOWWHENTRUE = "滿足條件時,高亮圖示"

EA_TTIP_SCD_REMOVEWHENCOOLDOWN = "冷卻時移除法術圖示"
EA_TTIP_SCD_GLOWWHENUSABLE = "當可用時高亮顯示 SCD 圖示"
EA_TTIP_SCD_NOCOMBATSTILLKEEP = "即使未進入戰鬥仍顯示 SCD 圖示"
EA_TTIP_SCD_ITEMCOOLDOWN = "開關物品冷卻偵測(影響效能,需重新載入UI)"
EA_TTIP_SHOWRUNESBAR = "將符文列顯示在BUFF列上方"

EA_XOPT_SCD_REMOVEWHENCOOLDOWN 	= "冷卻時移除法術圖示"
EA_XOPT_SCD_GLOWWHENUSABLE 		= "當可用時高亮顯示 SCD 圖示"
EA_XOPT_SCD_NOCOMBATSTILLKEEP	= "即使未進入戰鬥仍顯示 SCD 圖示"
EA_XOPT_SCD_ITEMCOOLDOWN 		= "開關物品冷卻偵測"
EA_XOPT_SHOWRUNESBAR = "是否顯示DK符文列"
...
EA_XOPT_SPELLCOND_AURAVALUE1   = "顯示光環數值 1"
EA_XOPT_SPELLCOND_AURAVALUE2   = "顯示光環數值 2"
EA_XOPT_SPELLCOND_AURAVALUE3   = "顯示光環數值 3"
EA_XOPT_SPELLCOND_AURAVALUE4   = "顯示光環數值 4"
...
EA_XICON_SNAMEFONTSIZE = "法術名稱字體大小"
EA_XICON_TIMERFONTSIZE = "倒數時間字體大小"
EA_XICON_STACKFONTSIZE = "層數字體大小"
...
EA_XGRPALERT_GLOWWHENTRUE = "滿足條件時高亮"
