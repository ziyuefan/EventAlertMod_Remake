...
檔案: LegacyReference\Main\EventAlert_IconOptions.lua
...
-----------------------------------
function G:Icon_Options_Frame_OnLoad()
...
function G:Icon_Options_Frame_Init()
	...
	EA_Icon_Options_Frame_SNameFontSize:SetValue(EA_Config.SNameFontSize)
	EA_Icon_Options_Frame_TimerFontSize:SetValue(EA_Config.TimerFontSize)
	EA_Icon_Options_Frame_StackFontSize:SetValue(EA_Config.StackFontSize)
...
function G:Icon_Options_Frame_ToggleAlertFrame()
	if EA_Anchor_Frame1:IsVisible() then
		...
		if (EA_Config.ShowFrame == true) then
			...
			G:Icon_Options_Frame_PaintAlertFrame()
		end
		...
		G:Icon_Options_Frame_ToggleNewLineAnchor()
...
function G:Icon_Options_Frame_SetAlertFrameText(eaf, spellName, toSetTextAndShow)
	if (eaf ~= nil) then
...
function G:Icon_Options_Frame_PaintAlertFrame()
	if EA_Anchor_Frame1 ~= nil then
		if EA_Anchor_Frame1:IsVisible() then
			...
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame1,  EA_XICON_SELF_BUFF.."(1)", true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame2,  EA_XICON_SELF_BUFF.."(2)", true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame3,  EA_XICON_SELF_SPBUFF, true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame4,  EA_XICON_SELF_DEBUFF.."(2)", true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame5,  EA_XICON_TARGET_DEBUFF.."(1)", true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame6,  EA_XICON_TARGET_DEBUFF.."(2)", true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame7,  EA_XICON_TARGET_SPBUFF, true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame8,  EA_XICON_TARGET_BUFF.."(2)", true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame9,  EA_XICON_SCD.."(1)", true)
			G:Icon_Options_Frame_SetAlertFrameText(EA_Anchor_Frame10, EA_XICON_SCD.."(2)", true)
	...
	--�䴩�t�M�t��
	if (G.playerClass == EA_CLASS_PALADIN) then
		-- Paladin Holy Power
		if (EA_Config.SpecPowerCheck.HolyPower) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.HolyPower)], "", false)  
		end		
		-- Paladin Mana
		if (EA_Config.SpecPowerCheck.Mana) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Mana)], "", false)			
		end
		
	--�䴩DK�Ť�βů�
	elseif (G.playerClass == EA_CLASS_DK) then
		-- Death Knight Runic
		if (EA_Config.SpecPowerCheck.RunicPower) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.RunicPower)], "", false)
		end
		-- Death Knight Runes
		if (EA_Config.SpecPowerCheck.Runes) then
			-- G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Runes)], "", false)
		end
		
	-- �䴩�w�|��s���I�ơB���B��q�B�P��B�ͩR����
	elseif (G.playerClass == EA_CLASS_DRUID) then
		...
		if (EA_Config.SpecPowerCheck.ComboPoints) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.ComboPoints)], "", false)
		end
		
		-- Druid Energy
		if (EA_Config.SpecPowerCheck.Energy) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Energy)], "", false)
		end
		
		-- Druid Rage
		if (EA_Config.SpecPowerCheck.Rage) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Rage)], "", false)
		end
		
		-- Druid Lunar Power
		if (EA_Config.SpecPowerCheck.LunarPower) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.LunarPower)], "", false)
			-- Durid Eclipse
			-- G:Icon_Options_Frame_SetAlertFrameText(EAFrameSpec_10081, "", false)  
			-- Durid Eclipse Orange
			-- G:Icon_Options_Frame_SetAlertFrameText(EAFrameSpec_10082, "", false)                                          			
		end
		
		-- Druid LifeBloom
		if (EA_Config.SpecPowerCheck.LifeBloom) then
			G:Icon_Options_Frame_SetAlertFrameText(EAFrameSpec_33763, "", false)  
		end
		
		
		
	-- �䴩�s���q�γs���I��
	elseif (G.playerClass == EA_CLASS_ROGUE) then
		-- Rogue Combo Points
		if (EA_Config.SpecPowerCheck.ComboPoints) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.ComboPoints)], "", false)
		end
	...
	-- �䴩�T�t�N�h
	elseif (G.playerClass == EA_CLASS_WARLOCK) then 
		-- Warlock Soul Shards
		if (EA_Config.SpecPowerCheck.SoulShards) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.SoulShards)], "", false)
		end
			
		-- Warlock Burning Embers
		if (EA_Config.SpecPowerCheck.BurningEmbers) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.BurningEmbers)], "", false)
		end
			
		-- Warlock Demonic Fury
		if (EA_Config.SpecPowerCheck.DemonicFury) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.DemonicFury)], "", false)			
		end
		
	--  �䴩�Z���u��
	elseif (G.playerClass == EA_CLASS_MONK) then
		-- Monk Light Force (Chi)
		if (EA_Config.SpecPowerCheck.Chi) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Chi)], "", false)			
		end
	...
	--  �䴩�t���t�v�_�](�ƨg)
	elseif (G.playerClass == EA_CLASS_PRIEST) then	
		-- Shadwo Priest Insanity
		if (EA_Config.SpecPowerCheck.Insanity) then		
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Insanity)], "", false)			
		end
	...
	--  �䴩�Ԥh���
	elseif (G.playerClass == EA_CLASS_WARRIOR) then 
		-- Warrior Rage
		if (EA_Config.SpecPowerCheck.Rage) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Rage)], "", false)			
		end		
	...
	--  �䴩�y�H������
	elseif (G.playerClass == EA_CLASS_HUNTER) then 
		-- Hunter Focus
		if (EA_Config.SpecPowerCheck.Focus) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Focus)], "", false)						
		end
		-- Hunter Pet Focus
		if (EA_Config.SpecPowerCheck.PetFocus) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Focus + 1)], "", false)			
		end
		
	--  �䴩���k�R��
	elseif (G.playerClass == EA_CLASS_MAGE) then 
		-- Mage Arcane Charges
		if (EA_Config.SpecPowerCheck.ArcaneCharges) then			
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.ArcaneCharges)], "", false)			
		end
		
	--  �䴩�W�j�Ĥ����Ī�����(�x��)
	elseif (G.playerClass == EA_CLASS_SHAMAN) then 
		-- Shaman Maelstrom
		if (EA_Config.SpecPowerCheck.Maelstrom) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Maelstrom)], "", false)			
		end
		
	--  �䴩�c�]�y�H�]��
	elseif (G.playerClass == EA_CLASS_DEMONHUNTER) then 
		-- Demonhunter Fury
		if (EA_Config.SpecPowerCheck.Fury) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Fury)], "", false)								
		end
		-- Demonhunter Pain
		if (EA_Config.SpecPowerCheck.Pain) then			
			-- G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Pain)], "", false)											
		end	
	
	--  �䴩���v�s��
	elseif (G.playerClass == EA_CLASS_EVOKER) then 
		-- Evoker's Essence
		if (EA_Config.SpecPowerCheck.Essence) then
			G:Icon_Options_Frame_SetAlertFrameText(_G["EAFrameSpec_"..(1000000 + 10 * Enum.PowerType.Essence)], "", false)										
		end		
	...
	if EA_Config.SpecPowerCheck.Vigor then
		G:Icon_Options_Frame_SetAlertFrameText(EAFrameSpec_Vigor, "", false)  
	end
end


function G:Icon_Options_Frame_AdjustTimerFontSize()
	
	-- local fontSize = EA_Config.TimerFontSize
	
	-- if (EA_Config.ChangeTimer == true) then	--�Y�p����ܦb�ج[��
		-- -- �Y�ϥΤF�p���I�˼�
		-- if (EA_Config.UseFloatSec > 0) then
			-- EA_Config.TimerFontSize = fontSize * 0.8		--�ج[���˼Ƥj�p���(���p���I)
		-- else
			-- EA_Config.TimerFontSize = fontSize	 			--�ج[���˼Ƥj�p���(�L�p���I)
		-- end
		-- EA_Config.StackFontSize = fontSize * 1/1.5			--���|�p�Ƥj�p���
	-- else	--�Y�p����ܦb�ج[�~
		-- EA_Config.TimerFontSize = fontSize * 1.25			--�ج[�~�˼Ƥj�p���
		-- EA_Config.StackFontSize = fontSize * 1/1.5 * 1.25	--���|�p�Ƥj�p���
	-- end
	
	
	
	-- EA_Config.SNameFontSize = 
	-- if EA_Config.SNameFontSize < 10 then EA_Config.SNameFontSize = 10 end
	
end

function G:Icon_Options_Frame_ResetFrame()
	if (EA_Config.LockFrame == true) then
		...
		EA_Icon_Options_Frame_IconGreenDebuff:SetValue((EA_Position.GreenDebuff * 100) - 50)
		G:Icon_Options_Frame_ToggleNewLineAnchor()
		G:Icon_Options_Frame_ToggleAlertFrame()
		-- G:Icon_Options_Frame_ToggleAlertFrame()
	end
end


function G:Icon_Options_Frame_MouseDown(button)
	if button == "LeftButton" then
		-- EA_Icon_Options_Frame:StartMoving()
	end
end

function G:Icon_Options_Frame_MouseUp(button)
	if button == "LeftButton" then
		EA_Icon_Options_Frame:StopMovingOrSizing()
	end
end

function G:Icon_Options_Frame_ToggleNewLineAnchor()
	if (EA_Position.Tar_NewLine) then
		EA_Anchor_Frame5:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown2)
		EA_Anchor_Frame5:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp2)
		EA_Anchor_Frame6:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown2)
		EA_Anchor_Frame6:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp2)
		EA_Anchor_Frame7:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown2)
		EA_Anchor_Frame7:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp2)
		EA_Anchor_Frame8:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown2)
		EA_Anchor_Frame8:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp2)
	else
		EA_Anchor_Frame5:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown)
		EA_Anchor_Frame5:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp)
		EA_Anchor_Frame6:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown)
		EA_Anchor_Frame6:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp)
		EA_Anchor_Frame7:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown)
		EA_Anchor_Frame7:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp)
		EA_Anchor_Frame8:SetScript("OnMouseDown", G.Icon_Options_Frame_Anchor_OnMouseDown)
		EA_Anchor_Frame8:SetScript("OnMouseUp", G.Icon_Options_Frame_Anchor_OnMouseUp)
	end
end

function G:Icon_Options_Frame_Anchor_OnMouseDown()
	if (EA_Config.LockFrame == true) then
		DEFAULT_CHAT_FRAME:AddMessage("\124cffFFFF00EventAlertMod\124r: "..EA_XICON_LOCKFRAMETIP)
	else
...
function G:Icon_Options_Frame_Anchor_OnMouseUp()
...
function G:Icon_Options_Frame_Anchor_OnMouseDown2()
	if (EA_Config.LockFrame == true) then
		DEFAULT_CHAT_FRAME:AddMessage("\124cffFFFF00EventAlertMod\124r: "..EA_XICON_LOCKFRAMETIP)
	else
...
function G:Icon_Options_Frame_Anchor_OnMouseUp2()
...
function G:Icon_Options_Frame_Anchor_OnMouseDown3()
	if (EA_Config.LockFrame == true) then
		DEFAULT_CHAT_FRAME:AddMessage("\124cffFFFF00EventAlertMod\124r: "..EA_XICON_LOCKFRAMETIP)
	else
...
function G:Icon_Options_Frame_Anchor_OnMouseUp3()
...
-- function G:Icon_Options_Frame_DirectSelect_OnLoad(DropDown, DropTypeIndex)
-- 	local function MyDropDownClick(self)
-- 		G:Icon_Options_Frame_DirectSelect_OnClick(self, DropDown, DropTypeIndex)
-- 	end
-- 
...
-- end
-- 
-- function G:Icon_Options_Frame_DirectSelect_OnClick(self, DropDown, DropTypeIndex)
