...
檔案: LegacyReference\Main\EventAlert_Options.lua
...
-----------------------------------------------------
function G:Options_OnLoad()
	-- UIPanelWindows["EA_Options_Frame"] = {area = "center", pushable = 0}
	return
end
-----------------------------------------------------
function G:EAFun_SetButtonState(button, state)
	if state == 1 then
...
function G:Options_Init()
	...
	EA_Options_Frame_Header_Text:SetFontObject(G.FONT_OBJECT)
	...
	EA_Options_Frame_SCDRemoveWhenCooldown:SetChecked(EA_Config.SCD_RemoveWhenCooldown)
	EA_Options_Frame_SCDNocombatStillKeep:SetChecked(EA_Config.SCD_NocombatStillKeep)
	EA_Options_Frame_SCDGlowWhenUsable:SetChecked(EA_Config.SCD_GlowWhenUsable)
	EA_Options_Frame_SCDItemCooldown:SetChecked(EA_Config.SCD_ItemCooldown)
	EA_Options_Frame_ShowRunesBar:SetChecked(EA_Config.ShowRunesBar)	

	-- EA_Options_Frame_ToggleClassEvents:Disable()
	
	local sTexturePath = "interface/buttons/ui-panel-button-down.blp"
...
-----------------------------------------------------
function G:Options_ToggleIconOptionsFrame()
	...
	if EA_Icon_Options_Frame:IsVisible() then
		...
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleIconOptions, 0)
	else
		...
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleIconOptions, 1)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleClassEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleOtherEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleTargetEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleSCDEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleGroupEvents, 0)
	end
end
-----------------------------------------------------
function G:Options_ToggleClassEventsFrame()
	...
	if EA_Class_Events_Frame:IsVisible() then
		...
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleIconOptions, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleClassEvents, 1)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleOtherEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleTargetEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleSCDEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleGroupEvents, 0)
...
-----------------------------------------------------
function G:Options_ToggleOtherEventsFrame()
	...
	if EA_Other_Events_Frame:IsVisible() then
		...
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleIconOptions, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleClassEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleOtherEvents, 1)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleTargetEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleSCDEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleGroupEvents, 0)
	end
...
-----------------------------------------------------
function G:Options_ToggleTargetEventsFrame()
	EA_SpellCondition_Frame:Hide()
	EA_GroupEventSetting_Frame:Hide()
	if EA_Target_Events_Frame:IsVisible() then
		...
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleClassEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleOtherEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleTargetEvents, 1)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleSCDEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleGroupEvents, 0)
	end
end
-----------------------------------------------------
function G:Options_ToggleSCDEventsFrame()
	EA_SpellCondition_Frame:Hide()
	EA_GroupEventSetting_Frame:Hide()
	if EA_SCD_Events_Frame:IsVisible() then
		...
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleOtherEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleTargetEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleSCDEvents, 1)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleGroupEvents, 0)
	end
end
-----------------------------------------------------
function G:Options_ToggleGroupEventsFrame()
	...
	if EA_Group_Events_Frame:IsVisible() then
		...
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleTargetEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleSCDEvents, 0)
		G:EAFun_SetButtonState(EA_Options_Frame_ToggleGroupEvents, 1)
	end
end
-----------------------------------------------------
function G:Options_CloseAnchorFrames()
	EA_SpellCondition_Frame:Hide()
	EA_GroupEventSetting_Frame:Hide()
	local iGroupCnt = #EA_GrpItems[G.playerClass]
...
G.GroupItems = {}
G.OrderIndexs = {}
G.TempGroupValids = nil	-- [SpellIndex][CheckIndex][SubCheckCnts] = true/false
G.Group_CfgFramePrefix = "EAGECfgFrame"
-----------------------------------------------------
function G:EAFun_GroupEvent_GetValueFromFrameItem(FrameItemName, fIsDropdown)
...
-----------------------------------------------------
function G:EAFun_GroupEvent_GetValueFromGroupItem(Param, iSpellIndex, iCheckIndex, iSubCheckIndex)
	local fGetValue, sReturnValue = false, nil
	if iSubCheckIndex ~= nil then
		-- Get SubCheck Values
		if G.GroupItems.Spells[iSpellIndex] ~= nil then
		if G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex] ~= nil then
		if G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex] ~= nil then
			sReturnValue = G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex][Param]
		end
		end
		end
	elseif iCheckIndex ~= nil then
		...
		if G.GroupItems.Spells[iSpellIndex] ~= nil then
		if G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex] ~= nil then
			sReturnValue = G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex][Param]
		end
		end
	elseif iSpellIndex ~= nil then
		-- Get Spell Values
		if G.GroupItems.Spells[iSpellIndex] ~= nil then
			sReturnValue = G.GroupItems.Spells[iSpellIndex][Param]
		end
	end
...
-- 	for iInd_i, aValue_i in ipairs(G.TempGroupValids) do
...
function G:EAFun_GroupEvent_LoadGroupEventToFrame(GroupID)
	local ipairs = ipairs
	local AddNewCheckBtn, AddNewSubCheckBtn = nil, nil
	G:EAFun_GroupEvent_ClearAllSpell_Click()
	G.OrderIndexs = {}
	if (GroupID <= #EA_GrpItems[G.playerClass]) then
		G.GroupItems = EA_GrpItems[G.playerClass][GroupID]
	...
	EA_GroupEventSetting_Frame.IconPoint = G.GroupItems.IconPoint
	EA_GroupEventSetting_Frame.IconRelatePoint = G.GroupItems.IconRelatePoint
	EA_GroupEventSetting_Frame_IconSize:SetValue(G.GroupItems.IconSize)
	EA_GroupEventSetting_Frame_IconAlpha:SetValue(G.GroupItems.IconAlpha * 100)
	...
	if (G.GroupItems.ActiveTalentGroup) ~= nil then
		if (G.GroupItems.ActiveTalentGroup==1) then EA_GroupEventSetting_Frame_Talent1:SetChecked(true) end
		if (G.GroupItems.ActiveTalentGroup==2) then EA_GroupEventSetting_Frame_Talent2:SetChecked(true) end
		if (G.GroupItems.ActiveTalentGroup==3) then EA_GroupEventSetting_Frame_Talent3:SetChecked(true) end
		if (G.GroupItems.ActiveTalentGroup==4) then EA_GroupEventSetting_Frame_Talent4:SetChecked(true) end
	end
	EA_GroupEventSetting_Frame_HideOnLeaveCombat:SetChecked(false)
	if (G.GroupItems.HideOnLeaveCombat) ~= nil then
		if (G.GroupItems.HideOnLeaveCombat) then EA_GroupEventSetting_Frame_HideOnLeaveCombat:SetChecked(true) end
	end
	EA_GroupEventSetting_Frame_HideOnLostTarget:SetChecked(false)
	if (G.GroupItems.HideOnLostTarget) ~= nil then
		if (G.GroupItems.HideOnLostTarget) then EA_GroupEventSetting_Frame_HideOnLostTarget:SetChecked(true) end
	end
	EA_GroupEventSetting_Frame_GlowWhenTrue:SetChecked(false)
	if (G.GroupItems.GlowWhenTrue) ~= nil then
		if (G.GroupItems.GlowWhenTrue) then EA_GroupEventSetting_Frame_GlowWhenTrue:SetChecked(true) end
	end
	EA_GroupEventSetting_Frame_LocX:SetText(G.GroupItems.LocX or "")
	EA_GroupEventSetting_Frame_LocY:SetText(G.GroupItems.LocY or "")
	for iInd_i, aValue_i in ipairs(G.GroupItems.Spells) do
		-- G.TempGroupValids[iInd_i] = {}
		G.EAFun_GroupEvent_AddNewSpellBtn_Click(EAGE_SpellsFrame_NewSpellBtn)
		for iInd_j, aValue_j in ipairs(aValue_i.Checks) do
			-- G.TempGroupValids[iInd_i][iInd_j] = {}
			-- if (iInd_j == 1) then G.GroupItems.Spells[iInd_i].Checks[iInd_j].CheckAndOp = true end
			if (iInd_j >= 2) then
				AddNewCheckBtn = _G[G.Group_CfgFramePrefix..iInd_i.."_NewCheckBtn"]
				G.EAFun_GroupEvent_AddNewCheckBtn_Click(AddNewCheckBtn)
			end
			for iInd_k, aValue_k in ipairs(aValue_j.SubChecks) do
				-- G.TempGroupValids[iInd_i][iInd_j][iInd_k] = true
				-- if (iInd_k == 1) then G.GroupItems.Spells[iInd_i].Checks[iInd_j].SubChecks[iInd_k].SubCheckAndOp = true end
				if (iInd_k >= 2) then
					AddNewSubCheckBtn = _G[G.Group_CfgFramePrefix..iInd_i.."_"..iInd_j.."_NewSubCheckBtn"]
					G.EAFun_GroupEvent_AddNewSubCheckBtn_Click(AddNewSubCheckBtn)
				end
			end
		end
	end
...
function G:EAFun_GroupEvent_SaveFrameToGroupEvent()
	-- Some logic, valid all of G.GroupItems and G.TempGroupValids, confirm which item is valid.
	-- and then save G.GroupItems to EA_GrpItems[G.playerClass][GroupID]
	local ipairs = ipairs
	local fHasSpellItem, fHasCheckItem, fHasSubCheckItem, fCheckValid = false, false, false, true
	local aTempSubCheckItem	= wipe(aTempSubCheckItem)
	local aTempCheckItem	= wipe(aTempCheckItem)
	local aTempSpellItem	= wipe(aTempSpellItem)
	local aTempGroupItem	= wipe(aTempGroupItem)
	...
	aTempGroupItem			= wipe(aTempGroupItem)
	aTempGroupItem.Spells	= {}
	iSpellIndex = 0
	fHasSpellItem = false
	local iInd_i, aValue_i = 0, nil
	-- print ("---------- Print Save GroupItem Logs ----------")
	-- for iInd_i, aValue_i in ipairs(G.TempGroupValids) do	-- [SpellIndex][CheckIndex][SubCheckCnts] = true/false
	for iOrdInd_i, iOrdValue_i in ipairs(G.OrderIndexs) do
		iInd_i = iOrdValue_i
		aValue_i = G.TempGroupValids[iInd_i]
		aTempSpellItem = wipe(aTempSpellItem)
		aTempSpellItem.Checks = {}
		iCheckIndex = 0
		fHasCheckItem = false
		for iInd_j, aValue_j in ipairs(aValue_i) do	-- [CheckIndex][SubCheckCnts] = true/false
			aTempCheckItem = wipe(aTempCheckItem)
			...
			for iInd_k, aValue_k in ipairs(aValue_j) do	-- [SubCheckCnts] = true/false
				if (aValue_k) then
					...
					fCheckValid = true
					sSubCheckFramePrefix = G.Group_CfgFramePrefix..iInd_i.."_"..iInd_j.."_"..iInd_k
					aTempSubCheckItem = wipe(aTempSubCheckItem)

					-- Logic AND/OR
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckOpDropdown", true)
					...
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckEventTypeDowndown", true)
					
					aTempSubCheckItem.EventType = sReturnValue

					-- UnitType
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckUnitTypeDowndown", true)
					
					aTempSubCheckItem.UnitType = sReturnValue

					-- (Optional)Check cooldown
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckCDTextBox")
					...
					if (aTempSubCheckItem.EventType == "UNIT_POWER_UPDATE") then
						-- PowerType
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckPowerTypeDowndown", true)
						
						aTempSubCheckItem.PowerTypeNum = sReturnValue

						-- CompType: 1:<, 2:<=, 3:=, 4:>=, 5:>
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckPowerCompDowndown", true)
						...
						fGetValue, PowerValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckPowerTextBox")
						if (not fGetValue) then fCheckValid = false end
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckPowerCompTypeDowndown", true)
					...
					elseif (aTempSubCheckItem.EventType == "UNIT_HEALTH") then
						-- CompType: 1:<, 2:<=, 3:=, 4:>=, 5:>
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckHealthCompDowndown", true)
						-- if (sReturnValue == 1) then sReturnValue = true else sReturnValue = false end
						aTempSubCheckItem.HealthCompType = sReturnValue

						-- (1 in 2)Value or Percent
						local HealthValue = nil
						fGetValue, HealthValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckHealthTextBox")
						if (not fGetValue) then fCheckValid = false end
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckHealthCompTypeDowndown", true)
					...
					elseif (aTempSubCheckItem.EventType == "UNIT_AURA") then
						...
						local AuraValue = nil
						fGetValue, AuraValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckAuraIDTextBox")
						if (not fGetValue) then fCheckValid = false end
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckAuraExistDowndown", true)
						...
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckTimeCompDowndown", true)
						-- if (sReturnValue == 1) then sReturnValue = true else sReturnValue = false end
						aTempSubCheckItem.TimeCompType = sReturnValue

						-- (Only Exists) time seconds
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckAuraTimeTextBox")
						...
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckStackCompDowndown", true)
						-- if (sReturnValue == 1) then sReturnValue = true else sReturnValue = false end
						aTempSubCheckItem.StackCompType = sReturnValue

						-- (Only Exists) stacks
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckAuraStackTextBox")
					...
					elseif (aTempSubCheckItem.EventType == "UNIT_COMBO_POINTS") then
						-- <=:true, >=:false
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckComboCompDowndown", true)
						-- if (sReturnValue == 1) then sReturnValue = true else sReturnValue = false end
						aTempSubCheckItem.ComboCompType = sReturnValue

						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSubCheckFramePrefix.."_SubCheckComboTextBox")
			...
			if (fHasSubCheckItem) then
				...
				fCheckValid = true
				sCheckFramePrefix = G.Group_CfgFramePrefix..iInd_i.."_"..iInd_j
				fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sCheckFramePrefix.."_CheckOpDropdown", true)
		...
		if (fHasCheckItem) then
			...
			fCheckValid = true
			sSpellFramePrefix = G.Group_CfgFramePrefix..iInd_i
			fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromFrameItem(sSpellFramePrefix.."_SpellTextBox")
	...
	if (fHasSpellItem) then
		...
		if (EA_GroupEventSetting_Frame_GlowWhenTrue:GetChecked()) then aTempGroupItem.GlowWhenTrue = true end

		-- This is a Valid GroupItem, Update or Append to current GroupID
		G:CreateFrames_EventsFrame_ClearSpellList(6)
		-- wipe GC_IndexOfGroupFrame
		G.GC_IndexOfGroupFrame = {}
		local iGroupID = EA_GroupEventSetting_Frame.GroupID
		EA_GrpItems[G.playerClass][iGroupID] = aTempGroupItem
		-- create all frames
		G:CreateFrames_EventsFrame_CreateSpellList(6)
		-- refresh all icons
		G:CreateFrames_EventsFrame_RefreshSpellList(6)
	end
end
-----------------------------------------------------
function G:EAFun_GroupEvent_ClearAllSpell_Click()
	local SpellFrame, CheckFrame, SubCheckFrame = nil, nil, nil
	local ipairs = ipairs
	if (G.TempGroupValids ~= nil) then
		for iInd_i, aValue_i in ipairs(G.TempGroupValids) do
			for iInd_j, aValue_j in ipairs(aValue_i) do
				for iInd_k, aValue_k in ipairs(aValue_j) do
					SubCheckFrame = _G[G.Group_CfgFramePrefix..iInd_i.."_"..iInd_j.."_"..iInd_k]
					if SubCheckFrame~= nil then SubCheckFrame:Hide() end
				end
				CheckFrame = _G[G.Group_CfgFramePrefix..iInd_i.."_"..iInd_j]
				if CheckFrame~= nil then CheckFrame:Hide() end
			end
			SpellFrame = _G[G.Group_CfgFramePrefix..iInd_i]
...
-- 	for i, v in ipairs(G.OrderIndexs) do
...
-- end
-----------------------------------------------------
function G.EAFun_GroupEvent_OrderBtn_OnClick(self)
	...
	local SpellFrame = _G[G.Group_CfgFramePrefix..iSpellIndex]
	...
	if (fGoToMove) then
		if (fOrderUp) then
			...
			G.OrderIndexs[iPreOrderIndex] = iSpellIndex
			G.OrderIndexs[iOrderIndex] = iPreSpellIndex
			...
			G.OrderIndexs[iNextOrderIndex] = iSpellIndex
			G.OrderIndexs[iOrderIndex] = iNextSpellIndex
...
-----------------------------------------------------
function G:EAFun_GroupEvent_CloseBtn_OnClick()
	...
	local sSpellFramePrefix = G.Group_CfgFramePrefix..iSpellIndex
	...
	if (iCloseLevel == 1) then
		...
		iRootOffsetX = 0
		for iInd_j, aValue_j in ipairs(G.TempGroupValids[iSpellIndex]) do
			for iInd_k, aValue_k in ipairs(aValue_j) do
				G.TempGroupValids[iSpellIndex][iInd_j][iInd_k] = false
			end
		end
	elseif (iCloseLevel == 2) then
		sCheckFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex
		...
		for iInd_k, aValue_k in ipairs(G.TempGroupValids[iSpellIndex][iCheckIndex]) do
			G.TempGroupValids[iSpellIndex][iCheckIndex][iInd_k] = false
		end
	elseif (iCloseLevel == 3) then
		sCheckFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex
		sSubCheckFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex
		...
		G.TempGroupValids[iSpellIndex][iCheckIndex][iSubCheckIndex] = false
	end
...
-----------------------------------------------------
function G.EAFun_GroupEvent_SpellTextOnEnterPressed(self)
	local iSpellID = tonumber(self:GetText())
	if (iSpellID ~= nil) then
		local spellInfo = GetSpellInfo(iSpellID)
		local sName = (type(spellInfo) == "table") and spellInfo.name or select(1, spellInfo)
		local sIcon = GetSpellTexture(iSpellID)
...
-----------------------------------------------------
function G:EAFun_GetUnitNameWithTitle(Title, UnitID)
...
function G:EAFun_GroupEvent_DropDown_OnLoad(DropDown, ItemValues, DefaultValue, ExtraInfo)
	local function MyDropDownClick(self)
		G.EAFun_GroupEvent_DropDown_OnClick(self, DropDown, DefaultValue, ExtraInfo)
	end
	local function MyDropDownInit()
		...
		if (ItemValues == EA_XGRPALERT_UNITTYPES) then
			for iItemIndex, aItemValue in ipairs(ItemValues) do
				AddItem(G:EAFun_GetUnitNameWithTitle(aItemValue.text, aItemValue.value), aItemValue.value)
			end
		else
			for iItemIndex, aItemValue in ipairs(ItemValues) do
	...
	if (ExtraInfo ~= nil) then
		if (ExtraInfo.EventIndex == nil) then
			G:EAFun_GroupEvent_ChangeEventType_Click(DefaultValue, ExtraInfo)
		else
			G:EAFun_GroupEvent_ChangeAuraCheck_Click(DefaultValue, ExtraInfo)
		end
	end
end
-----------------------------------------------------
function G.EAFun_GroupEvent_DropDown_OnClick(self, DropDown, DefaultValue, ExtraInfo)
	local SelValue = self.value
	if SelValue == nil then SelValue = DefaultValue end
	UIDropDownMenu_SetSelectedValue(DropDown, SelValue)
	if (ExtraInfo ~= nil) then
		if (ExtraInfo.EventIndex == nil) then
			G:EAFun_GroupEvent_ChangeEventType_Click(SelValue, ExtraInfo)
		else
			G:EAFun_GroupEvent_ChangeAuraCheck_Click(SelValue, ExtraInfo)
		end
	end
end
...
-- Show a SpellIcon
function G.EAFun_GroupEvent_AddNewSpellBtn_Click(self)
	...
	G.OrderIndexs[iSpellIndex] = iSpellIndex
	G.TempGroupValids[iSpellIndex] = {}
	...
	Lib_ZYF:SetBackdrop(SpellFrame,{bgFile="", edgeFile="Interface/Tooltips/UI-Tooltip-Border"})	
	...
	CloseBtn:SetScript("OnClick", G.EAFun_GroupEvent_CloseBtn_OnClick)
	...
	if (SpellText1 == nil) then
		SpellText1 = SpellFrame:CreateFontString(sSpellFramePrefix.."_SpellText1", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	SpellText1:SetPoint("TOPLEFT", CloseBtn, "TOPRIGHT", 0, -2)
	SpellText1:SetText("["..iSpellIndex.."]"..EX_XCLSALERT_SPELL)

	--// G.GroupItems.Spells[iSpellIndex].SpellIconID
	--// G.Group_CfgFramePrefix..iSpellIndex.."_SpellTextBox"
	...
	if (SpellTextBox == nil) then
		...
		sDefaultValue = ""
		fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("SpellIconID", iSpellIndex)
		if (fGetValue) then
			sDefaultValue = sReturnValue
		end
	SpellTextBox:SetText(sDefaultValue)
	SpellTextBox:SetScript("OnEnterPressed", G.EAFun_GroupEvent_SpellTextOnEnterPressed)
	...
	if (SpellText2 == nil) then
		SpellText2 = SpellFrame:CreateFontString(sSpellFramePrefix.."_SpellText2", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	...
	if (SpellName == nil) then
		SpellName = SpellFrame:CreateFontString(sSpellFramePrefix.."_SpellName", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	...
	if (SpellText3 == nil) then
		SpellText3 = SpellFrame:CreateFontString(sSpellFramePrefix.."_SpellText3", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	...
	G.EAFun_GroupEvent_SpellTextOnEnterPressed(SpellTextBox)
	...
	OrderUpBtn:SetScript("OnClick", G.EAFun_GroupEvent_OrderBtn_OnClick)
	OrderUpBtn:Show()
	...
	OrderDownBtn:SetScript("OnClick", G.EAFun_GroupEvent_OrderBtn_OnClick)
	OrderDownBtn:Show()
	...
	NewCheckBtn:Show()
	NewCheckBtn:SetScript("OnClick",G.EAFun_GroupEvent_AddNewCheckBtn_Click)
	...
	G.EAFun_GroupEvent_AddNewCheckBtn_Click(NewCheckBtn)
end
-------------------------------------------------------
-- Create Check Configuration Items
-- Show a Logic-Operation
-------------------------------------------------------
function G.EAFun_GroupEvent_AddNewCheckBtn_Click(self)
	self.CheckCnts = self.CheckCnts + 1
	local iSpellIndex = self.SpellIndex
	local iCheckIndex = self.CheckCnts
	local fGetValue, sReturnValue, sDefaultValue = false, nil, nil
	local sSpellFramePrefix = G.Group_CfgFramePrefix..iSpellIndex
	local sCheckFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex
	...
	G.TempGroupValids[iSpellIndex][iCheckIndex] = {}
	local SpellFrame = _G[sSpellFramePrefix]
	...
	if (CheckTitle == nil) then
		CheckTitle = CheckFrame:CreateFontString(sCheckFramePrefix.."_CheckTitle", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	CheckTitle:SetPoint("TOPLEFT", CloseBtn, "TOPRIGHT", 0, -2)
	CheckTitle:SetText("["..iCheckIndex.."]"..EA_XGRPALERT_TITLECHECK)
	
	--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].CheckAndOp
	--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_CheckOpDropdown"
	...
	if (CheckOpDropdown == nil) then
		...
		sDefaultValue = 1
		fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("CheckAndOp", iSpellIndex, iCheckIndex)
		if (fGetValue) then
			if (sReturnValue) then sDefaultValue = 1 else sDefaultValue = 0 end
		end
	UIDropDownMenu_SetWidth(CheckOpDropdown, 60)
	G:EAFun_GroupEvent_DropDown_OnLoad(CheckOpDropdown, EA_XGRPALERT_LOGICS, sDefaultValue)
	...
	NewSubCheckBtn:Show()
	NewSubCheckBtn:SetScript("OnClick", G.EAFun_GroupEvent_AddNewSubCheckBtn_Click)
	...
	G.EAFun_GroupEvent_AddNewSubCheckBtn_Click(NewSubCheckBtn)
end
-------------------------------------------------------
-- Create SubCheck Configuration Items
-- Show a Logic-Operation, EventType, UnitType...
-------------------------------------------------------
function G.EAFun_GroupEvent_AddNewSubCheckBtn_Click(self)
	...
	local sSpellFramePrefix = G.Group_CfgFramePrefix..iSpellIndex
	local sCheckFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex
	local sSubCheckFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex
	...
	G.TempGroupValids[iSpellIndex][iCheckIndex][iSubCheckIndex] = true
	local SpellFrame = _G[sSpellFramePrefix]
	local CheckFrame = _G[sCheckFramePrefix]
	...
	if (SubCheckTitle == nil) then
		SubCheckTitle = SubCheckFrame:CreateFontString(sSubCheckFramePrefix.."_SubCheckTitle", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	SubCheckTitle:SetPoint("TOPLEFT", CloseBtn, "TOPRIGHT", 0, -2)
	SubCheckTitle:SetText("["..iSubCheckIndex.."]"..EA_XGRPALERT_TITLESUBCHECK)

	--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].SubCheckAndOp
	--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckOpDropdown"
	...
	if (SubCheckOpDropdown == nil) then
		...
		sDefaultValue = 1
		fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("SubCheckAndOp", iSpellIndex, iCheckIndex, iSubCheckIndex)
		if (fGetValue) then
			if (sReturnValue) then sDefaultValue = 1 else sDefaultValue = 0 end
		end
	UIDropDownMenu_SetWidth(SubCheckOpDropdown, 60)
	G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckOpDropdown, EA_XGRPALERT_LOGICS, sDefaultValue)
	...
	if (SubCheckText1 == nil) then
		SubCheckText1 = SubCheckFrame:CreateFontString(sSubCheckFramePrefix.."_SubCheckText1", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	SubCheckText1:SetPoint("TOPLEFT", SubCheckOpDropdown, "TOPRIGHT", 0, -5)
	SubCheckText1:SetText(EA_XGRPALERT_EVENTTYPE)

	--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].EventType
	--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckEventTypeDowndown"
	...
	if (SubCheckEventTypeDowndown == nil) then
		...
		fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("EventType", iSpellIndex, iCheckIndex, iSubCheckIndex)
		if (fGetValue) then
			sDefaultValue = sReturnValue
		end
	UIDropDownMenu_SetWidth(SubCheckEventTypeDowndown, 210)
	G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckEventTypeDowndown, EA_XGRPALERT_EVENTTYPES, sDefaultValue, ExtraInfo)
	...
	if (SubCheckText2 == nil) then
		SubCheckText2 = SubCheckFrame:CreateFontString(sSubCheckFramePrefix.."_SubCheckText2", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	SubCheckText2:SetPoint("TOPLEFT", SubCheckTitle, "BOTTOMLEFT", 0, -10)
	SubCheckText2:SetText(EA_XGRPALERT_UNITTYPE)

	--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].UnitType
	--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckUnitTypeDowndown"
	...
	if (SubCheckUnitTypeDowndown == nil) then
		...
		fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("UnitType", iSpellIndex, iCheckIndex, iSubCheckIndex)
		if (fGetValue) then
			sDefaultValue = sReturnValue
		end
	UIDropDownMenu_SetWidth(SubCheckUnitTypeDowndown, 170)
	G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckUnitTypeDowndown, EA_XGRPALERT_UNITTYPES, sDefaultValue)
	...
	if (SubCheckText3 == nil) then
		SubCheckText3 = SubCheckFrame:CreateFontString(sSubCheckFramePrefix.."_SubCheckText3", "ARTWORK", G.FONT_OBJECT:GetName())
	end
	SubCheckText3:SetPoint("TOPLEFT", SubCheckUnitTypeDowndown, "TOPRIGHT", 0, -5)
	SubCheckText3:SetText(EA_XGRPALERT_CHECKCD)

	--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].CheckCD
	--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckCDTextBox"
	...
	if (SubCheckCDTextBox == nil) then
		...
		sDefaultValue = ""
		fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("CheckCD", iSpellIndex, iCheckIndex, iSubCheckIndex)
		if (fGetValue) then
			sDefaultValue = sReturnValue
		end
...
-------------------------------------------------------
function G:EAFun_GroupEvent_ChangeEventType_Click(EventType, ExtraInfo)
		...
		if (iLoop ~= iShowEventIndex) then	
			...
			if (iLoop == 1) then
				...
				if (SubEventPowerText1 == nil) then
					SubEventPowerText1 = SubEventFrame:CreateFontString(sSubCheckFramePrefix.."_SubEventPowerText1", "ARTWORK", G.FONT_OBJECT:GetName())
				end
				SubEventPowerText1:SetPoint("TOPLEFT", SubEventFrame, "TOPLEFT", 0, -58)
				SubEventPowerText1:SetText(EA_XGRPALERT_POWERTYPE)
				
				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].PowerTypeNum
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckPowerTypeDowndown"
				...
				if (SubCheckPowerTypeDowndown == nil) then
					...
					sDefaultValue = 0
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("PowerTypeNum", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						sDefaultValue = sReturnValue
					end
				UIDropDownMenu_SetWidth(SubCheckPowerTypeDowndown, 90)
				G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckPowerTypeDowndown, EA_XGRPALERT_POWERTYPES, sDefaultValue)
				SubCheckPowerTypeDowndown:SetPoint("TOPLEFT", SubEventPowerText1, "TOPRIGHT", -15, 5)
				SubCheckPowerTypeDowndown:Show()

				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].PowerCompType
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckPowerCompDowndown"
				...
				if (SubCheckPowerCompDowndown == nil) then
					...
					sDefaultValue = 1
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("PowerCompType", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						-- if (sReturnValue) then sDefaultValue = 1 else sDefaultValue = 0 end
						sDefaultValue = sReturnValue
					end
				UIDropDownMenu_SetWidth(SubCheckPowerCompDowndown, 60)
				G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckPowerCompDowndown, EA_XGRPALERT_COMPARES, sDefaultValue)
				SubCheckPowerCompDowndown:SetPoint("TOPLEFT", SubCheckPowerTypeDowndown, "TOPRIGHT", -30, 0)
				SubCheckPowerCompDowndown:Show()

				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].PowerLessThanValue or PowerLessThanPercent
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckPowerCompTypeDowndown"
				...
				if (SubCheckPowerCompTypeDowndown == nil) then
					...
					sDefaultValue = 1
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("PowerLessThanPercent", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						if (sReturnValue ~= nil) then sDefaultValue = 2 end
					end
				UIDropDownMenu_SetWidth(SubCheckPowerCompTypeDowndown, 75)
				G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckPowerCompTypeDowndown, EA_XGRPALERT_COMPARETYPES, sDefaultValue)
				SubCheckPowerCompTypeDowndown:SetPoint("TOPLEFT", SubCheckPowerCompDowndown, "TOPRIGHT", -30, 0)
				SubCheckPowerCompTypeDowndown:Show()

				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].PowerLessThanValue or PowerLessThanPercent
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckPowerTextBox"
				...
				if (SubCheckPowerTextBox == nil) then
					...
					sDefaultValue = ""
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("PowerLessThanValue", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
			...
			elseif (iLoop == 2) then
				...
				if (SubEventHealthText1 == nil) then
					SubEventHealthText1 = SubEventFrame:CreateFontString(sSubCheckFramePrefix.."_SubEventHealthText1", "ARTWORK", G.FONT_OBJECT:GetName())
				end
				SubEventHealthText1:SetPoint("TOPLEFT", SubEventFrame, "TOPLEFT", 0, -58)
				SubEventHealthText1:SetText(EA_XGRPALERT_HEALTH)
				
				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].HealthCompType
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckHealthCompDowndown"
				...
				if (SubCheckHealthCompDowndown == nil) then
					...
					sDefaultValue = 1
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("HealthCompType", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						-- if (sReturnValue) then sDefaultValue = 1 else sDefaultValue = 0 end
						sDefaultValue = sReturnValue
					end
				UIDropDownMenu_SetWidth(SubCheckHealthCompDowndown, 60)
				G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckHealthCompDowndown, EA_XGRPALERT_COMPARES, sDefaultValue)
				SubCheckHealthCompDowndown:SetPoint("TOPLEFT", SubEventHealthText1, "TOPRIGHT", -15, 5)
				SubCheckHealthCompDowndown:Show()

				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].HealthLessThanValue or HealthLessThanPercent
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckHealthCompTypeDowndown"
				...
				if (SubCheckHealthCompTypeDowndown == nil) then
					...
					sDefaultValue = 1
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("HealthLessThanPercent", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						if (sReturnValue ~= nil) then sDefaultValue = 2 end
					end
				UIDropDownMenu_SetWidth(SubCheckHealthCompTypeDowndown, 75)
				G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckHealthCompTypeDowndown, EA_XGRPALERT_COMPARETYPES, sDefaultValue)
				...
				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].HealthLessThanValue or HealthLessThanPercent
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckHealthTextBox"
				...
				if (SubCheckHealthTextBox == nil) then
					...
					sDefaultValue = ""
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("HealthLessThanValue", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						if (sReturnValue ~= nil) then sDefaultValue = sReturnValue end
					else
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("HealthLessThanPercent", iSpellIndex, iCheckIndex, iSubCheckIndex)
			...
			elseif (iLoop == 3) then
				...
				if (SubEventAuraText1 == nil) then
					SubEventAuraText1 = SubEventFrame:CreateFontString(sSubCheckFramePrefix.."_SubEventAuraText1", "ARTWORK", G.FONT_OBJECT:GetName())
				end
				SubEventAuraText1:SetPoint("TOPLEFT", SubEventFrame, "TOPLEFT", 0, -58)
				SubEventAuraText1:SetText(EA_XGRPALERT_CHECKAURA)
				
				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].CheckAuraExist or CheckAuraNotExist
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckAuraExistDowndown"
				...
				if (SubCheckAuraExistDowndown == nil) then
					...
					sDefaultValue = 1
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("CheckAuraNotExist", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						if (sReturnValue ~= nil) then sDefaultValue = 2 end
					end
				UIDropDownMenu_SetWidth(SubCheckAuraExistDowndown, 75)
				G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckAuraExistDowndown, EA_XGRPALERT_CHECKAURAS, sDefaultValue, ExtraInfo)
				SubCheckAuraExistDowndown:SetPoint("TOPLEFT", SubEventAuraText1, "TOPRIGHT", -15, 5)
				SubCheckAuraExistDowndown:Show()

				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].CheckAuraExist or CheckAuraNotExist
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckAuraIDTextBox"
				...
				if (SubCheckAuraIDTextBox == nil) then
					...
					sDefaultValue = ""
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("CheckAuraExist", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						if (sReturnValue ~= nil) then sDefaultValue = sReturnValue end
					else
						fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("CheckAuraNotExist", iSpellIndex, iCheckIndex, iSubCheckIndex)
				...
				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].CastByPlayer
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckCastByPlayerCheckBox"
				...
				if (SubCheckCastByPlayerCheckBox == nil) then
					...
					sDefaultValue = false
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("CastByPlayer", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						sDefaultValue = sReturnValue
					end
			...
			elseif (iLoop == 4) then
				...
				if (SubEventComboText1 == nil) then
					SubEventComboText1 = SubEventFrame:CreateFontString(sSubCheckFramePrefix.."_SubEventComboText1", "ARTWORK", G.FONT_OBJECT:GetName())
				end
				SubEventComboText1:SetPoint("TOPLEFT", SubEventFrame, "TOPLEFT", 0, -58)
				SubEventComboText1:SetText(EA_XGRPALERT_COMBOPOINT)

				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].ComboCompType
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckComboCompDowndown"
				...
				if (SubCheckComboCompDowndown == nil) then
					...
					sDefaultValue = 1
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("ComboCompType", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						-- if (sReturnValue) then sDefaultValue = 1 else sDefaultValue = 0 end
						sDefaultValue = sReturnValue
					end
				UIDropDownMenu_SetWidth(SubCheckComboCompDowndown, 60)
				G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckComboCompDowndown, EA_XGRPALERT_COMPARES, sDefaultValue)
				SubCheckComboCompDowndown:SetPoint("TOPLEFT", SubEventComboText1, "TOPRIGHT", -15, 5)
				SubCheckComboCompDowndown:Show()

				--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].ComboLessThanValue
				--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckComboTextBox"
				...
				if (SubCheckComboTextBox == nil) then
					...
					sDefaultValue = ""
					fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("ComboLessThanValue", iSpellIndex, iCheckIndex, iSubCheckIndex)
					if (fGetValue) then
						sDefaultValue = sReturnValue
					end
...
-------------------------------------------------------
function G:EAFun_GroupEvent_ChangeAuraCheck_Click(AuraCheck, ExtraInfo)
	local iSpellIndex = ExtraInfo.SpellIndex
	local iCheckIndex = ExtraInfo.CheckIndex
	local iSubCheckIndex= ExtraInfo.SubCheckIndex
	...
	local sSubCheckFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex
	local sSubEventFramePrefix = G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_"..iEventIndex
	...
	if (AuraCheck == 2) then	-- Hide this AuraCheckItems Frame
		...
		if (SubEventAuraText2 == nil) then
			SubEventAuraText2 = SubAuraCheckFrame:CreateFontString(sSubCheckFramePrefix.."_SubEventAuraText2", "ARTWORK", G.FONT_OBJECT:GetName())
		end
		SubEventAuraText2:SetPoint("TOPLEFT", SubAuraCheckFrame, "TOPLEFT", 10, -3)
		SubEventAuraText2:SetText(EA_XGRPALERT_AURATIME)
		
		--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].TimeCompType
		--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckTimeCompDowndown"
		...
		if (SubCheckTimeCompDowndown == nil) then
			...
			sDefaultValue = 1
			fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("TimeCompType", iSpellIndex, iCheckIndex, iSubCheckIndex)
			if (fGetValue) then
				-- if (sReturnValue) then sDefaultValue = 1 else sDefaultValue = 0 end
				sDefaultValue = sReturnValue
			end
		UIDropDownMenu_SetWidth(SubCheckTimeCompDowndown, 50)
		G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckTimeCompDowndown, EA_XGRPALERT_COMPARES, sDefaultValue)
		SubCheckTimeCompDowndown:SetPoint("TOPLEFT", SubEventAuraText2, "TOPRIGHT", -15, 5)
		SubCheckTimeCompDowndown:Show()

		--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].TimeLessThanValue
		--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckAuraTimeTextBox"
		...
		if (SubCheckAuraTimeTextBox == nil) then
			...
			sDefaultValue = ""
			fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("TimeLessThanValue", iSpellIndex, iCheckIndex, iSubCheckIndex)
			if (fGetValue) then
				sDefaultValue = sReturnValue
			end
		...
		if (SubEventAuraText3 == nil) then
			SubEventAuraText3 = SubAuraCheckFrame:CreateFontString(sSubCheckFramePrefix.."_SubEventAuraText3", "ARTWORK", G.FONT_OBJECT:GetName())
		end
		SubEventAuraText3:SetPoint("TOPLEFT", SubCheckAuraTimeTextBox, "TOPRIGHT", 10, -3)
		SubEventAuraText3:SetText(EA_XGRPALERT_AURASTACK)
		
		--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].StackCompType
		--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckStackCompDowndown"
		...
		if (SubCheckStackCompDowndown == nil) then
			...
			sDefaultValue = 1
			fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("StackCompType", iSpellIndex, iCheckIndex, iSubCheckIndex)
			if (fGetValue) then
				-- if (sReturnValue) then sDefaultValue = 1 else sDefaultValue = 0 end
				sDefaultValue = sReturnValue
			end
		UIDropDownMenu_SetWidth(SubCheckStackCompDowndown, 50)
		G:EAFun_GroupEvent_DropDown_OnLoad(SubCheckStackCompDowndown, EA_XGRPALERT_COMPARES, sDefaultValue)
		SubCheckStackCompDowndown:SetPoint("TOPLEFT", SubEventAuraText3, "TOPRIGHT", -15, 5)
		SubCheckStackCompDowndown:Show()

		--// G.GroupItems.Spells[iSpellIndex].Checks[iCheckIndex].SubChecks[iSubCheckIndex].StackLessThanValue
		--// G.Group_CfgFramePrefix..iSpellIndex.."_"..iCheckIndex.."_"..iSubCheckIndex.."_SubCheckAuraStackTextBox"
		...
		if (SubCheckAuraStackTextBox == nil) then
			...
			sDefaultValue = ""
			fGetValue, sReturnValue = G:EAFun_GroupEvent_GetValueFromGroupItem("StackLessThanValue", iSpellIndex, iCheckIndex, iSubCheckIndex)
			if (fGetValue) then
				sDefaultValue = sReturnValue
			end
...
--
------------------------------------------------------------------------------------------------
function G:Options_AlertSoundSelect_OnLoad()	
	UIDropDownMenu_Initialize(EA_Options_Frame_AlertSoundSelect, G.Options_AlertSoundSelect_Initialize)	
...
G.AlertSoundList={ 	
				...
				[2]	= {["FluteRun"]						= 569642},
				[3]	= {["Netherwind"]					= 569487},
				[4]	= {["PolyMorphCow"]					= 568761},
				[5]	= {["RockBiter"]					= 569545},
				[6]	= {["YarrrrImpact"]					= 568382},
				[7]	= {["BrokenHeart"]					= 568945},
				[8]	= {["MillhouseReady"]				= 555336},
				[9]	= {["MillhousePyro"]				= 555337},
				[10]= {["SatyrePissed"]					= 559630},
				[11]= {["MortarTeamPissed"]				= 555839},	
				[12]= {["ShaolinFootball"]				= "Interface\\AddOns\\EventAlertMod\\Music\\ShaolinFootball.mp3"},					
			}
------------------------------------------------------------------------------------------------
--
------------------------------------------------------------------------------------------------
function G:Options_AlertSoundSelect_Initialize()
	...
	local function AddItem(text, value)
		info.text = text
		info.func = G.Options_AlertSoundSelect_OnClick
		info.value = value
		if (info.value == selectedValue) then
			info.checked = 1
		end
	...
	local soundName,tbl
	for i, tbl in ipairs(G.AlertSoundList) do
		for sound,fileId in pairs(tbl) do 
			AddItem(sound, i)
		end
	end
...
--
------------------------------------------------------------------------------------------------
function G:Options_AlertSoundSelect_OnClick()
	...
	if SelValue then 
		local soundName, fileId
		for soundName, fileId in pairs(G.AlertSoundList[SelValue]) do 
			EA_Config.AlertSound = fileId
		end
	end
...
--
------------------------------------------------------------------------------------------------
function G:Options_MouseDown(button)
...
--
------------------------------------------------------------------------------------------------
function G:Options_MouseUp(button)
	if button == "LeftButton" then
