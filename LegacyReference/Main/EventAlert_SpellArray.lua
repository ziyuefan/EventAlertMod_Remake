...
檔案: LegacyReference\Main\EventAlert_SpellArray.lua
...
function G:LoadClassSpellArray(ItemType)
	...
	if (ItemType == 1) or (ItemType == 9 and EA_Items[G.playerClass] == nil) then
		
		EA_Items[G.playerClass] = {}
		for i, v in G:pairsByKeys(EADef_Items[G.playerClass]["ITEMS"]) do
			i = tonumber(i)
			if EA_Items[G.playerClass][i] == nil then EA_Items[G.playerClass][i] = v end
			if GetSpellInfo(i) == nil then EA_Items[G.playerClass][i] = nil end
		end
	end
	if (ItemType == 2) or (ItemType == 9 and EA_AltItems[G.playerClass] == nil) then
		EA_AltItems[G.playerClass] = {}
		for i, v in G:pairsByKeys(EADef_Items[G.playerClass]["ALTITEMS"]) do
			i = tonumber(i)
			if EA_AltItems[G.playerClass][i] == nil then EA_AltItems[G.playerClass][i] = v end
			if GetSpellInfo(i) == nil then EA_AltItems[G.playerClass][i] = nil end
		end
	end
	if (ItemType == 3) or (ItemType == 9 and EA_Items[EA_CLASS_OTHER] == nil) then
		EA_Items[EA_CLASS_OTHER] = {}
		for i, v in G:pairsByKeys(EADef_Items[EA_CLASS_OTHER]) do
			i = tonumber(i)
	...
	if (ItemType == 4) or (ItemType == 9 and EA_TarItems[G.playerClass] == nil) then
		EA_TarItems[G.playerClass] = {}
		for i, v in G:pairsByKeys(EADef_Items[G.playerClass]["TARITEMS"]) do
			i = tonumber(i)
			if EA_TarItems[G.playerClass][i] == nil then EA_TarItems[G.playerClass][i] = v end
			if GetSpellInfo(i) == nil then EA_TarItems[G.playerClass][i] = nil end
		end
	end
	if (ItemType == 5) or (ItemType == 9 and EA_ScdItems[G.playerClass] == nil) then
		EA_ScdItems[G.playerClass] = {}
		for i, v in G:pairsByKeys(EADef_Items[G.playerClass]["SCDITEMS"]) do
			i = tonumber(i)
			if EA_ScdItems[G.playerClass][i] == nil then EA_ScdItems[G.playerClass][i] = v end
			if GetSpellInfo(i) == nil then EA_ScdItems[G.playerClass][i] = nil end
		end
	end
	if (ItemType == 6) or (ItemType == 9 and EA_GrpItems[G.playerClass] == nil) then
		EA_GrpItems[G.playerClass] = {}
		local iGroupCnts = 0
		--if (#EA_GrpItems[G.playerClass] ~= nil) then iGroupCnts = #EA_GrpItems[G.playerClass] end
		for i, v in G:pairsByKeys(EADef_Items[G.playerClass]["GRPITEMS"]) do
			i = tonumber(i)
			if EA_GrpItems[G.playerClass][iGroupCnts+i] == nil then EA_GrpItems[G.playerClass][iGroupCnts+i] = {} end
			-- EA_GrpItems[G.playerClass][iGroupCnts+i] = v
			EA_GrpItems[G.playerClass][iGroupCnts+i] = CopyTable(v)
		end
	end
end


function G:LoadSpellArray()
...
--------------------------------------------------------------------------------
    ...
    ["GRPITEMS"] = {
        ...
        [10] = {
            ...
            ["GroupIconID"] = 0,
            ["enable"] = false,
            ["LocY"] = -91.611320495605,
            ["GroupResult"] = false,
            ["LocX"] = 321.77777099609,
            ["ActiveTalentGroup"] = 3,
            ["IconAlpha"] = 0.5,
            ["Spells"] = {
                [1] = {
        ...
        [11] = {
            ...
            ["GroupIconID"] = 0,
            ["enable"] = false,
            ["LocY"] = -8.0556802749634,
            ["GroupResult"] = false,
            ["LocX"] = 321.77627563477,
            ["ActiveTalentGroup"] = 3,
            ["IconAlpha"] = 0.5,
            ["Spells"] = {
                [1] = {
        ...
        [13] = {
            ...
            ["GroupIconID"] = 0,
            ["enable"] = false,
            ["LocY"] = 159.48306274414,
            ["LocX"] = 322.66690063477,
            ["GroupResult"] = false,
            ["Spells"] = {
                [1] = {
                    ["SpellIconPath"] = 236219,
        ...
        [14] = {
            ...
            ["GroupIconID"] = 0,
            ["enable"] = false,
            ["LocY"] = -209.77772521973,
            ["LocX"] = 325.33389282227,
            ["GroupResult"] = false,
            ["Spells"] = {
                [1] = {
                    ["SpellIconPath"] = 236219,
...
--------------------------------------------------------------------------------
	...
	-- Primary Alert / 本職業提醒區
		["ITEMS"] = {
			...
			[188501] = {enable=true, self=true},				--靈視
			[203981] = {enable=true, self=true},				--靈魂碎片(殘片)
