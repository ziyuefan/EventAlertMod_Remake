...
---
#### [Retail  12.1.0  ]2026.06.09
- 零分配與事件驅動全模組架構重構（完全數據與視圖解耦）
- 引入 AlertManager 中介控制器與 Scheduler 節流
- 影子載體技術 (Shadow Host) 實作與 UI 避讓
- 16 大全新與高頻魔獸事件整合
- 靜態 JIT 編譯性能優化與故障隔離
- 自動化打包發佈工具 (Build-CurseForgePackage.ps1) 多項 Bug 修正與安全防禦升級
---
#### [Retail  12.0.7  ]2026.06.06
- 專精與職業名稱動態 API 本地化重構
- 全專案硬編碼字串清掃與五大語系字典補齊
